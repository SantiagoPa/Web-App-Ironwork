    ...
    <div className="col-5 shadow__chart mt-2 d-flex flex-column justify-content-center">
      <div className="row my-2">
        <div className="col d-flex flex-column">
          <span>Cliente:</span>
          <span>{customerInfo ? "nombre: " + customerInfo.name : ""}</span>
      ...
      <div className="d-flex flex-column">
        <div className="d-flex py-4 justify-content-between">
          ...
          >
            ...
            />
            <button className="btn btn-outline-warning ms-2">hacer descuento</button>
          </form>
          <div className="col d-flex justify-content-end aling-items-center">
            <span className="text-dark mx-2">descuento: <em className="text-warning">{myDiscount}</em></span>
          </div>
        </div>
